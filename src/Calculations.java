public class Calculations {
    ...
    static String sin(String a) {
        double number1 = Double.parseDouble(a);
        return String.valueOf(Math.sin(Math.toRadians(number1))); // Convert degrees to radians
    }

    // Cos operation
    static String cos(String a) {
        double number1 = Double.parseDouble(a);
        return String.valueOf(Math.cos(Math.toRadians(number1))); // Convert degrees to radians
    }

    // Tan operation
    static String tan(String a) {
        double number1 = Double.parseDouble(a);
        return String.valueOf(Math.tan(Math.toRadians(number1))); // Convert degrees to radians
    }
}
